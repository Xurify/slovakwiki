...
<main><div class="grid grid-cols-[minmax(0,1fr)_210px] max-[1080px]:block">
  ...
  <aside class="context-rail sticky top-(--header-height) h-fit min-w-0 border-l border-slate-200 px-[18px] pb-12 pt-8 max-[1080px]:static max-[1080px]:grid max-[1080px]:grid-cols-2 max-[1080px]:gap-8 max-[1080px]:border-l-0 max-[1080px]:border-t max-[1080px]:px-[30px] max-[1080px]:py-6 max-[760px]:grid-cols-1 max-[760px]:gap-6 max-[760px]:px-3.5" aria-label="Entry navigation">
