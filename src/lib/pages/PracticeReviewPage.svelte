    ...
    {:else}
      ...
      >
        <div class="px-14 py-14 max-[800px]:px-5 max-[800px]:py-9">
          ...
          <p class="mt-[18px] max-w-[520px] text-[0.98rem] leading-[1.65] text-(--muted-strong)">
            You have no missed or revealed items right now. Keep building your Slovak by starting a
            lesson or exploring a focused practice set.
          </p>
          <div class="mt-7 flex flex-wrap items-center gap-[18px]">
            ...
            <a
              ...
              href="/practice">Browse practice</a
            >
          </div>
        </div>
        <aside
