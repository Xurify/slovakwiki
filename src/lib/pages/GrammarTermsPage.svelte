<main
  class="mx-auto w-[min(820px,calc(100%-48px))] py-9 pb-[74px] max-[620px]:w-[calc(100%-28px)] max-[620px]:py-7"
>
  <header>
    ...
    <h1 class="text-5xl font-semibold tracking-tight text-slate-900">Language terms</h1>
  ...
  <dl class="mt-9 border-t border-slate-300">
    ...
    >
      <dt class="font-serif text-lg font-bold text-blue-800">Case</dt>
    ...
    <div
      class="grid grid-cols-[160px_minmax(0,1fr)_auto] items-start gap-5 border-b border-slate-200 px-3 py-4 max-[620px]:grid-cols-1 max-[620px]:gap-1"
    >
      <dt class="font-serif text-lg font-bold text-blue-800">Tense</dt>
      <dd class="m-0 font-serif leading-6 text-slate-700">
        The time of an action: present, past, or future. Tense is one part of conjugation.
      </dd>
      <a
        class="whitespace-nowrap text-xs font-bold text-blue-800 underline underline-offset-2"
        href="/grammar/present-tense">Open present tense →</a
    ...
    <div
      class="grid grid-cols-[160px_minmax(0,1fr)_auto] items-start gap-5 border-b border-slate-200 px-3 py-4 max-[620px]:grid-cols-1 max-[620px]:gap-1"
    >
      <dt class="font-serif text-lg font-bold text-blue-800">Gender</dt>
      <dd class="m-0 font-serif leading-6 text-slate-700">
        A noun class: masculine, feminine, or neuter. Gender affects related word endings.
      </dd>
      <a
        class="whitespace-nowrap text-xs font-bold text-blue-800 underline underline-offset-2"
    ...
    <div
      class="grid grid-cols-[160px_minmax(0,1fr)_auto] items-start gap-5 border-b border-slate-200 px-3 py-4 max-[620px]:grid-cols-1 max-[620px]:gap-1"
    >
      <dt class="font-serif text-lg font-bold text-blue-800">Infinitive</dt>
      <dd class="m-0 font-serif leading-6 text-slate-700">
        The dictionary form of a verb: its unconjugated base form, such as rozumieť, “to
        understand.”
      </dd>
      <a
        class="whitespace-nowrap text-xs font-bold text-blue-800 underline underline-offset-2"
