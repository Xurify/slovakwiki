...
<main class="min-h-[calc(100vh-58px)]">
  ...
  >
    ...
    >
      <header class="pb-8">
        <p
          class="mb-4 text-xs font-semibold uppercase tracking-wide text-blue-700"
        >
            ...
            {#each visibleEntries as entry (entry.slug)}
              <li class="border-b border-slate-200 last:border-b-0">
                ...
                >
                  ...
                  <span
                    class="text-[0.95rem] text-slate-900 max-[760px]:col-start-1"
                  >
                    {entry.english}
                  </span>
                  <span
                    class="text-xs text-slate-500 max-[760px]:hidden"
                  >
                    {entry.category}
                  </span>
                  <svg
